...
`radian-trade-quote-pipe` is centered on trading systems work in Zig. The technical target is: Design a Zig verification harness for quote systems, covering format conversion, round-trip fixtures, and failure-oriented tests.
...
The score is deterministic. The current threshold is 158. Risk has a penalty of 5, latency has a penalty of 4, and weight contributes a bonus of 6.
