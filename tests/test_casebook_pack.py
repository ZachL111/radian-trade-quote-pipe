"""Regression checks for the radian-trade-quote-pipe casebook."""
...
from casebook.harness import assert_expected, radian_trade_quote_pipe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(radian_trade_quote_pipe_summary(), assert_expected())
